package org.example.exercices.exercice04WaterTank;
...
public class WaterTank {
    ...
    /** Remplie la citerne avec un montant (amount)
     * et retourne le possible débordement sinon 0.
     * @param amount montant d'eau
     * @return montant de débordement
     */
