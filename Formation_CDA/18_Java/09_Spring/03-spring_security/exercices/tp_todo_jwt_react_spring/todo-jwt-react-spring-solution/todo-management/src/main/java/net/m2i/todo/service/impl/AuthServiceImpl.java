...
import net.m2i.todo.exception.TodoAPIException;
import net.m2i.todo.repository.RoleRepository;
import net.m2i.todo.repository.UserRepository;
import net.m2i.todo.security.JwtTokenProvider;
import net.m2i.todo.service.AuthService;
...
public class AuthServiceImpl implements AuthService {
    ...
    public String register(RegisterDto registerDto) {
        ...
        Role userRole = roleRepository.findRoleBy(registerDto.getIdRole());
        roles.add(userRole);
