package com.example.__exercice_cuisine.controller;

import com.example.__exercice_cuisine.model.Category;
import com.example.__exercice_cuisine.model.Recipe;
import com.example.__exercice_cuisine.service.CategoryService;
import com.example.__exercice_cuisine.service.RecipeService;
...
public class RecipeController {
    ...
    public String add(@Valid @ModelAttribute("recipe") Recipe recette, BindingResult result){
        if(result.hasErrors()) {
            ...
            Category category = categoryService.getById(UUID.fromString(recette.getCategorieId()));
