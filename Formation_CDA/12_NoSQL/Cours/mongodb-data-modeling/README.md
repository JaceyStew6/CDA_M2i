...
Imaginons une base de données de blog avec des articles et des commentaires.
...
Dans cet exemple, les commentaires sont imbriqués directement dans le document de l'article.
