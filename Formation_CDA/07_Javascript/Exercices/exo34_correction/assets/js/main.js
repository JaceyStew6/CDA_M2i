...
/**
 * Fonction permettant de retourner une version Capitilized d'un texte
 * @param {string} text
...
/**
 * Fonction permettant d'aller chercher le pokémon voulu dans PokéAPI et de mettre à jour le pokémon actuel
...
/**
 * Fonction permettant la remise à zéro de l'interface de l'application
 */
...
/**
 * Fonction permettant la mise à jour de notre interface via un objet de type Pokémon
 */
